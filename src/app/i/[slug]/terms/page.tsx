...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return { title: `Terms & Conditions — ${insurer?.name ?? 'Insurance'}` }
}
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <div className="prose prose-sm max-w-none text-muted-foreground space-y-6">
          <section>
            ...
            <p>By using this insurance onboarding platform, you agree to these terms. This platform facilitates health insurance applications in accordance with IRDAI regulations.</p>
          </section>
          <section>
            <h2 className="text-base font-semibold text-foreground">2. Data Usage</h2>
            <p>Personal data collected (including mobile number, PAN, and health information) is used solely for the purpose of processing your insurance application.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>IRDAI mandates KYC verification for all health insurance policies. Your PAN and Aadhaar details are required for compliance.</p>
          </section>
          <section>
            <h2 className="text-base font-semibold text-foreground">5. Policy Issuance</h2>
            <p>A policy is issued only after successful underwriting review and payment confirmation. The insurer reserves the right to decline applications based on underwriting decisions.</p>
          </section>
          <section>
