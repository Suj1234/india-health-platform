    ...
    <div className="mx-auto max-w-md px-4 py-12">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">Secure payment via Razorpay. Your policy is issued instantly after payment.</p>
        </div>
        ...
        <Button onClick={handlePay} disabled={!orderData || paying} loading={paying} size="xl" variant="accent" className="w-full font-bold shadow-xl shadow-accent-500/30 mb-3">
