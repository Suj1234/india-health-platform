...
const JOURNEY_STEPS = [
  ...
  { number: 3, label: 'Choose Plan', shortLabel: 'Plan' },
  { number: 4, label: 'Health', shortLabel: 'Health' },
  { number: 5, label: 'Review', shortLabel: 'Review' },
  { number: 6, label: 'Documents', shortLabel: 'Docs' },
  { number: 7, label: 'Payment', shortLabel: 'Pay' },
  { number: 8, label: 'Policy', shortLabel: 'Policy' },
]
              ...
              <div className="px-8 py-6 space-y-5">
                ...
                <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
                  ...
                  <p className="text-xs text-amber-600 text-center mt-3 font-medium">
                    Steps 7 &amp; 8 unlock after underwriter approval
                  </p>
                </div>
